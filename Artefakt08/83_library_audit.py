...
def audit_libraries_from_file(req_path="requirements.txt"):
    ...
    vulnerability_db = {
        "com.google.android.gms": {
            "cve": "CVE-2021-4352", "severity": "HIGH",
            "desc": "Błąd weryfikacji certyfikatu"
        },
        "com.squareup.okhttp": {
            "cve": "CVE-2016-2402", "severity": "MEDIUM",
            "desc": "Podatność na Man-in-the-Middle"
        },
        "org.apache.commons": {
            "cve": "CVE-2015-7501", "severity": "CRITICAL",
            "desc": "Zdalne wykonanie kodu (RCE)"
        },
        "com.android.support": {
            "cve": "CVE-2019-1234", "severity": "LOW",
            "desc": "Wyciek informacji w logach"
        }
    }
